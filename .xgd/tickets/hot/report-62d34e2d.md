...
created_by: xgd
created_at: '2026-07-24T07:04:41.258135+00:00'
updated_at: '2026-07-24T07:04:41.258135+00:00'
completed_at: null
...
| AC-631 surface fill = effective alpha-composited colour | test_UAT_AC631_surface_fill_is_composited_alpha_colour | yes — blended tint not raw white; opaque-white repro flagged, blended-match clean |
| AC-632 box-border delta; matching/absent then none | test_UAT_AC632_box_border_delta_cases | yes — colour-diff fires; identical/none produce no delta |
...
| AC-711 typography treatments + list marker per run | test_UAT_AC711_typography_treatments_and_list_marker_per_run | yes — 5 axes x (differ@tier / match / absent-guard) |
