...
updated_at: '2026-09-01T22:43:53.052201+00:00'
completed_at: null
...
Three separable defects: `promoteToSiteAsset` not registering what it promotes;
`get_asset` and `list_assets` disagreeing about which namespace they serve; and
nothing in the surface saying that registration is not a precondition for use.
