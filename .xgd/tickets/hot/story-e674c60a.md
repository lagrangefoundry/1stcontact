...
updated_at: '2026-08-07T20:27:53.151664+00:00'
completed_at: null
...
- Editing of any kind: clicking a segment, the field modal, and the write path
  ...
  what shape its answers arrive, and that the client code the gesture runs is
  *served* from it — never what that path validates, writes or refuses, and
  never what that code does once it runs.
