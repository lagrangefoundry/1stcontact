...
updated_at: '2026-07-29T04:39:28.282787+00:00'
completed_at: null
...
**In scope:** the capture axes (including the conditions under which an axis records a value at all), comparison tolerances/severities, the duplicate-text pairing rule, and the fontLoad diff direction of the intrinsic `values-diff` path.
