...
document-level edit marker and no outline treatment, and remain fully functional:
their links carry their destinations and their forms their destination and submit
verb.
...
contains no address, no region stamp, no edit marker and no outline treatment,
and that link destinations and form destination/verb are present. Compare the
bytes of both channels' output against the bytes produced for the same definition
without the edit channel and assert they are identical.