...
updated_at: '2026-07-28T18:01:33.682804+00:00'
completed_at: '2026-07-28T18:01:33.682804+00:00'
...
fields:
  ...
  - working_sha: 3d339ad0c837791a1708755e401fcdb93a4911fd
    reconcile_sha: null
    main_sha: 3d339ad0c837791a1708755e401fcdb93a4911fd
...
## REQ-51: Object-grouped inspection + comparison output (per-object params, incl. position)
...
## REQ-52: gigabytealchemy.ai: re-import with object-grouped fidelity tooling
...
## REQ-53: values-diff: exact match by default for reproducible axes (supersedes REQ-35)
...
## REQ-54: Styled-run text content model + markup (implements DOC-22)
...
## REQ-55: contentWidth: align to Tailwind max-w scale + literal escape hatch
...
## REQ-56: Component-owned typography: theme label scale + capture reads it + per-instance escape hatch
...
## REQ-57: Richer text block kinds — tables, code, rich/nested blockquotes, headings, nested list items
