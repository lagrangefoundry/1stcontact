...
updated_at: '2026-08-31T20:15:23.079360+00:00'
completed_at: null
...
shadow — what the system understands this to be), and the fields from [[DOC-38]]
§9: `kind`, `origin`, `rights`. The shadow is editable: it is a ticket body, the
...
classify, write the shadow, create the ticket, index. This ticket owns the
