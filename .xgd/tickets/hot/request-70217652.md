...
updated_at: '2026-07-30T01:44:48.161299+00:00'
completed_at: null
...
`storage/sites/xgd/draft/pages/home.json` — `pointerAccent` on `#hero`, `#problem`
and `#close`: `radiusPx: 95` (~190px across), `softnessPx: 34`, `roughness: 0.65`.
