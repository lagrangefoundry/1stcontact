...
updated_at: '2026-08-10T07:48:20.976780+00:00'
completed_at: null
...
editor's width; it stays narrow. That narrowing is keyed on the absence of an
editing box rather than on the presence of a message, so a refusal appearing
...
refusal in an open fields form and assert its width is unchanged.
