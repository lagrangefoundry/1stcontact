---
uid: comment-7cb2d771
id: COMMENT-473
type: comment
title: Comment on bug BUG-16
created_by: xgd
created_at: '2026-07-24T22:28:54.053997+00:00'
updated_at: '2026-07-24T22:28:54.053997+00:00'
completed_at: null
...
Original `fields.commits` SHA(s) `4d51e086cbdb` went stale — the objects still exist (`git cat-file -t` succeeds) but are no longer an ancestor of `main` or `xgd-working`, because repeated resync rebase cycles re-authored them under new SHAs. No `git patch-id` match was found (conflict-resolution changed the diff slightly), but an exact, unique commit-message match on `xgd-working`'s full history identifies the re-authored commit(s): `1d04e4967fc1`.
