---
uid: comment-7e2096aa
id: COMMENT-505
type: comment
title: Comment on request REQ-41
created_by: xgd
created_at: '2026-07-24T22:31:26.242172+00:00'
updated_at: '2026-07-24T22:31:26.242172+00:00'
completed_at: null
...
Original `fields.commits` SHA(s) `3cfb7e9ddfc3` went stale — the objects still exist (`git cat-file -t` succeeds) but are no longer an ancestor of `main` or `xgd-working`, because repeated resync rebase cycles re-authored them under new SHAs. No `git patch-id` match was found (conflict-resolution changed the diff slightly), but an exact, unique commit-message match on `xgd-working`'s full history identifies the re-authored commit(s): `1137da7b6d18`.
