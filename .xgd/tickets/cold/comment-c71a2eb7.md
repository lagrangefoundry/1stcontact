---
uid: comment-c71a2eb7
id: COMMENT-502
type: comment
title: Comment on request REQ-73
created_by: xgd
created_at: '2026-07-24T22:31:13.182131+00:00'
updated_at: '2026-07-24T22:31:13.182131+00:00'
completed_at: null
last_field_updated: created_at
status: null
fields:
  subject_uid: request-859652ae
  kind: note
---

**BUG-863 stale-commit recovery**

Original `fields.commits` SHA(s) `f028323bb272` went stale — the objects still exist (`git cat-file -t` succeeds) but are no longer an ancestor of `main` or `xgd-working`, because repeated resync rebase cycles re-authored them under new SHAs. No `git patch-id` match was found (conflict-resolution changed the diff slightly), but an exact, unique commit-message match on `xgd-working`'s full history identifies the re-authored commit(s): `31262d54a1ab`.
