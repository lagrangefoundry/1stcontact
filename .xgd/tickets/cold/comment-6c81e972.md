---
uid: comment-6c81e972
id: COMMENT-470
type: comment
title: Comment on bug BUG-19
created_by: xgd
created_at: '2026-07-24T22:28:40.720618+00:00'
updated_at: '2026-07-24T22:28:40.720618+00:00'
completed_at: null
...
Original `fields.commits` SHA(s) `52bef8126f45` went stale — the objects still exist (`git cat-file -t` succeeds) but are no longer an ancestor of `main` or `xgd-working`, because repeated resync rebase cycles re-authored them under new SHAs. No `git patch-id` match was found (conflict-resolution changed the diff slightly), but an exact, unique commit-message match on `xgd-working`'s full history identifies the re-authored commit(s): `5ff0d6f10caa`.
