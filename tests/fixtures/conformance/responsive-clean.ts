 ...
 * path — an adequately-sized tap target (≥44px) and legible text (≥12px), with no
 * fixed-width overflow. It MUST pass at every viewport, proving the tap-target and
...
export const responsiveClean: BehaviorComponent = () => `<section style="padding: 24px">
  ...
  <button
    type="button"
    style="display: inline-block; min-width: 120px; min-height: 48px; padding: 12px 20px; font-size: 16px"
  >
    Get started
  </button>
</section>`
