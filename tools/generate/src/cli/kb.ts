 ...
 *
 * The middle step is the knowledge component composed directly rather than
...
/** The knowledge component, Worker-safe root. */
 ...
 * the `ai-knowledge` component, and the knowledge component cannot depend on
